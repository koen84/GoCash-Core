...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* GCASH features */
        {"gcash", "masternode", &masternode, true, true, false},
        {"gcash", "masternodelist", &masternodelist, true, true, false},
        {"gcash", "mnbudget", &mnbudget, true, true, false},
        {"gcash", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"gcash", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"gcash", "mnsync", &mnsync, true, true, false},
        {"gcash", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"gcash", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use gcashd, or the -server option to gcash-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> gcash-cli " + methodname + " " + args + "\n";
}
