...
public:
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        anonymizeGCASH = new QSpinBox(tabMain);
        anonymizeGCASH->setObjectName(QStringLiteral("anonymizeGCASH"));
        anonymizeGCASH->setMinimum(100);
        anonymizeGCASH->setMaximum(100000);
        anonymizeGCASH->setSingleStep(100);
        anonymizeGCASH->setValue(1000);

        horizontalLayout->addWidget(anonymizeGCASH);
...
#ifndef QT_NO_TOOLTIP
        bitcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start GCASH after logging in to the system.", 0));
#endif // QT_NO_TOOLTIP
        bitcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start GCASH on system login", 0));
...
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("OptionsDialog", "Amount of GCASH to keep anonymized", 0));
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the GCASH client port on the router. This only works when your router supports UPnP and it is enabled.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the GCASH network through a SOCKS5 proxy.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting GCASH.", 0));
#endif // QT_NO_TOOLTIP
...
"https://www.transifex.com/gcash-project/gcash-project-translations", 0));
