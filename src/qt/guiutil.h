...
/** Utility functions used by the GCASH Qt UI.
 */
namespace GUIUtil
{
...
// Render GCASH addresses in monospace font
...
// Parse "gcash:" URI into recipient object, return true on successful parsing
