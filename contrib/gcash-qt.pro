...
RESOURCES += src/qt/gcash.qrc src/qt/gcash_locale.qrc

TRANSLATIONS += src/qt/locale/gcash_bg.ts \
                src/qt/locale/gcash_de.ts \
                src/qt/locale/gcash_en.ts \
                src/qt/locale/gcash_es.ts \
                src/qt/locale/gcash_fi.ts \
                src/qt/locale/gcash_fr.ts \
                src/qt/locale/gcash_it.ts \
                src/qt/locale/gcash_ja.ts \
                src/qt/locale/gcash_pl.ts \
                src/qt/locale/gcash_pt.ts \
                src/qt/locale/gcash_ru.ts \
                src/qt/locale/gcash_sk.ts \
                src/qt/locale/gcash_sv.ts \
                src/qt/locale/gcash_vi.ts \
                src/qt/locale/gcash_zh_CN.ts \
                src/qt/locale/gcash_zh_TW.ts
